...
/*
   Se poate observa ca thread_function nu trebuie sa inchida fisierele
   de log.
...
int main ()
{
   ...
   /* creeaza o cheie care sa asocieze un thread cu pointerul catre fisierul lui de log in
      thread-specific data si foloseste close_thread_log ca functie de clean up */
